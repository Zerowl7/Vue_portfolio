...
<template>
    <section id="home"
        class="lg:h-[85vh] flex items-center bg-orange-100 dark:bg-dark-primary py-32 lg:py-8 overflow-hidden">
      ...
      y: 0,}">
            <div class="flex flex-col md:flex-row items-center h-full pt-8">
                <div class="flex-1 flex flex-col items-center lg:items-start">
                    <p class="text-lg text-accent text-md mb-[10px] pt-6"> Hey, I'm Maxim! 👋</p>
                    <h1 class="
              text-4xl
              leading-[44px]
            ...
            ">
              ...
              transition-all">
                ...
                <div class="flex flex-1 justify-end items-center h-full mt-8 md:mt-0">
                    <!-- //Here -->
                    <img class="rounded-lg" src="https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="Hero" />
                </div>
            </div>
        </div>
    </section>
